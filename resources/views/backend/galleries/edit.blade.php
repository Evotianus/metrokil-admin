        ...
        <div class="card bg-white py-4 px-7">
            ...
            <form action="{{ route('galleries.update', $gallery->id) }}" method="POST" id="blog-form" class="my-4 flex flex-col"
                    ...
                    <div class="col-span-4">
                        <div class="flex flex-col gap-2">
                            ...
                            <input type="text" name="name" id="title"
                                ...
                                placeholder="Nama Foto" value="{{ old('name', $gallery->name) }}">
                        </div>
                    </div>
                    <div class="col-span-2">
                        <div class="flex flex-col gap-2">
                            ...
                            <select name="category" id="category"
                                ...
                                <option value="Penyuntikan Anti Rayap Kusen Jendela" {{ old('category', $gallery->category) == 'Penyuntikan Anti Rayap Kusen Jendela' ? 'selected' : '' }}>
                                    Penyuntikan Anti Rayap Kusen Jendela</option>
                                <option value="Penyuntikan Anti Rayap Kusen Pintu" {{ old('category', $gallery->category) == 'Penyuntikan Anti Rayap Kusen Pintu' ? 'selected' : '' }}>Penyuntikan Anti Rayap Kusen Pintu</option>
                                <option value="Penyuntikan Anti Rayap Dinding Keramik Kamar Mandi" {{ old('category', $gallery->category) == 'Penyuntikan Anti Rayap Dinding Keramik Kamar Mandi' ? 'selected' : '' }}>Penyuntikan Anti Rayap Dinding Keramik Kamar Mandi</option Anti Rayap Lantai Dasar
                                <option value="Penyuntikan Anti Rayap Lantai Dasar" {{ old('category', $gallery->category) == 'Penyuntikan Anti Rayap Lantai Dasar' ? 'selected' : '' }}>Penyuntikan Anti Rayap Lantai Dasar</option>
                            </select>
                        </div>
                    </div>
                </div>
                <div class="flex flex-col gap-2 mt-3">
                    ...
                    <div class="flex items-center justify-center w-full">
                        <label for="dropzone-file"
                            ...
                            id="image-box"
                            style="background-image: url('{{ $gallery->image_path ? Storage::url($gallery->image_path) : '' }}'); background-size: contain; background-position: center; background-repeat: no-repeat;">
                            <div id="placeholder-content"
                                class="{{ $gallery->image_path ? 'hidden' : 'flex flex-col items-center justify-center pt-5 pb-6' }}">
                ...
                <div class="flex flex-col gap-2 mt-3">
                    ...
                    <div id="froala">{!! old('description', $gallery->description) !!}</div>
                </div>
            </form>
        </div>
    </div>
