    ...
    <div class="container-xxl container-p-y">
        ...
        <div class="mb-3 flex justify-between items-center">
            <div class="flex flex-col">
                <h2 class="text-2xl">Ubah Layanan</h2>
        ...
        <div class="card bg-white py-4 px-7">
            <h2 class="text-lg">Ubah Layanan</h2>
            <form action="{{ route('services.update', $service->id) }}" method="POST" id="blog-form" class="my-4 flex flex-col" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-span-4">
                        <div class="flex flex-col gap-2">
                            ...
                            <input type="text" name="name" id="nama"
                                ...
                                placeholder="Nama Layanan..." value="{{ old('name', $service->name) }}">
                        </div>
                    </div>
                    <div class="col-span-2">
                        <div class="flex flex-col gap-2">
                            ...
                            <input type="number" name="price" id="harga"
                                class="input-text border-slate-400 rounded-md placeholder:opacity-60 focus:ring-primary"
                                placeholder="Harga Layanan..." value="{{ old('price', $service->price) }}">
                        </div>
                    </div>
                            ...
                            <div id="benefits-container">
                                <div class="benefit-input-group flex items-center gap-2 mb-2">
                                    <input type="text" name="benefits[]"
                                        ...
                                        placeholder="Benefit Layanan..." value="{{ old('benefits.0', $service->benefits[0] ?? '') }}">
                                    <button type="button"
